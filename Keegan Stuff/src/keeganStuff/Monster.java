...
public class Monster {
	...
	public Monster (int enemyPower, int enemyStamina, int enemySize, int enemyStealth, int enemyHealth) {
		 ...
		 * Lesser shifter = Power 20, Stamina 60, Size 5, Stealth 1000, and Health 100 -- Can shape shift to some monsters, NPCs, and animals --
		 * Greater shifter = Power 50, Stamina 100, Size 5, Stealth 1000, and Health 200 -- Can shape shift to most none-boss monsters, NPCs, and animals --
		 * Wraith = Power 20, Stamina 200, Size 6, Stealth 100, and Health 150 -- Looks like a horrifying shadow, near invisible, has no allies -- 
		 ...
		 * Pikachu = Power 1, Stamina 1, Size 1, Stealth 1, and Health 1 -- Upon death says "I WAS ONLY IN THIS GAME BECAUSE I WAS SO POPULAR!!!" --
		 ...
		 * CHARLIE = Power 10000, Stamina 1, Size 4.9, Stealth 0, and Health 1500 -- Is A Secret Boss, when defeated will sometimes turn into QUAGSIRE --
		 * QUAGSIRE = Power 100000, Stamina 10, Size 3, Stealth 0, and Health 9999999999 -- May be created when CHARLIE is defeated, small but dangerous --
